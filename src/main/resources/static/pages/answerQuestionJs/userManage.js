...
function downloadExcel() {
    ...
    //         $.ajax({
    //             url : httpRequestUrl+"/admin/selectUserListToExcel",//后台方法名字
    //             type : 'POST',
    //             data : {
    //                 userName: userName
    //             },
    ...
    //     }
    // });
    location=httpRequestUrl+"/admin/selectUserListToExcel?userName="+userName.toString();
}
...
function addFunctionAlty(value, row, index) {
    ...
    btnText += "<button type=\"button\" id=\"btn_look\" onclick=\"resetPassword(" + "'" + row.username + "'" + ")\" style='width: 77px;' class=\"btn btn-default-g ajax-link\">重置密码</button>&nbsp;&nbsp;";
